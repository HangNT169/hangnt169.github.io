...
const filteredElements = Array.from(allElements).filter(element => !element.classList.contains('container-md') && !element.classList.contains('row') && !element.classList.contains('col-xl-8') && !element.classList.contains('avatar-container') && element.tagName !== 'H1' && !element.classList.contains('post-heading') && !element.classList.contains('post-subheading') && !element.classList.contains('fa-sun') && !element.classList.contains('fa-moon') && !element.classList.contains('post-meta'));
